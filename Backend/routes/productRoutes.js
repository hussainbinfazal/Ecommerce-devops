...
const { getProducts, getProductById, deleteProduct, updateProduct, createProduct, seedFakeProducts, allLikedProducts, likeProducts, generateProductDescriptionWithAi } = require('../controllers/productControllers');
...
router.post("/generate-description", generateProductDescriptionWithAi);
